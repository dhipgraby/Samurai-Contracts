...
/// @title One Year Staking Contract
/// @notice This contract allows users to stake tokens for a one-year duration.
/// @dev It interacts with the SamuraiStakingPlatform, AdminContract, and FeeContract for staking and fee calculations.
contract OneYearStakingContract {
    ...
    /// @notice Allows a user to stake tokens for one year.
    ...
    function stake(uint256 amount) external payable {
        ...
        // Define pool type and end timestamp for one-year staking
        uint256 poolType = 4;
