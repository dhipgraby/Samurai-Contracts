...
/// @title One Week Staking Contract
/// @notice This contract allows users to stake tokens for a one-week duration.
...
contract OneWeekStakingContract {
    ...
    /// @notice Allows a user to stake tokens for one week.
    ...
    function stake(uint256 amount) external payable {
        ...
        // Define pool type and end timestamp for one-week staking
        uint256 poolType = 1;
