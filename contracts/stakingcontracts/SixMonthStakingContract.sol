...
/// @title Six Month Staking Contract
/// @notice This contract allows users to stake tokens for a six-month duration.
/// @dev It interacts with the SamuraiStakingPlatform, AdminContract, and FeeContract for staking and fee calculations.
contract SixMonthStakingContract {
    ...
    /// @notice Allows a user to stake tokens for six months.
    ...
    function stake(uint256 amount) external payable {
        ...
        // Define pool type and end timestamp for six-months staking
        uint256 poolType = 3;
